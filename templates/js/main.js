...
window.onload = () => {
    ...
    for (let i = 0; i < tab_switchers.length; i++) {
        ...
        tab_switcher.addEventListener('click', () => {
            document.querySelector('.css-1xhj18k .css-ww7fgb').classList.remove('css-ww7fgb');
            tab_switcher.parentNode.classList.add('css-ww7fgb');
...
function SwitchPage (page_id) {
    ...
    let getButton = document.querySelector(".css-qouyfz",);
